...
class PricingModelForm extends React.PureComponent {
    ...
    handleSubmit(e) {
        ...
        if (this.validator.allValid()) {
            ...
            const { id } = this.props.match.params
            if (id && id === 'new') {
                this.props.create('formData', 'pricingInsight/pricing_model', data)
            } else {
                this.props.update('formData', 'pricingInsight/pricing_model', id, data)
            }
            this.resetForm();             
            this.goBack();
        } else {
    ...
    bindData = () => {
        const { id } = this.props.match.params
        if (id && id !== 'new') {                        
            crudService._get('pricingInsight/pricing_model', id).then((response) => {                
