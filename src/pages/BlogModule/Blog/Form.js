...
const initialState = {
  ...
  form: {
    ...
    category: "",
    meta_description: "page builder",
    details: "page buider",
    blog_topic_id: 3,
    meta_title: "page builder",
    meta_keywords: "page builder",
    status: 1,
    image: "https://itmapprod.s3.amazonaws.com/f5ZROfzn62",
    banner: "https://itmapprod.s3.amazonaws.com/H5wyc94VnT",
    slug: "page-builder",
    html: { html: "", css: "" },
  },
};
