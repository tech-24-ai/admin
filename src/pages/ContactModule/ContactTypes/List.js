...
class ContactTypeList extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  /*deleteData = (id) => {
        this.props.deleteCrud('form', 'contact_types', id);
    }
  ...
  editCrud(data) {
    this.props.history.push(`/admin/contact-type-form/${data.id}`);
  }

  /* addCrud() {
        this.props.history.push(`/admin/contact-type-form/new`)
    }*/
  ...
  render() {
    const columns = [
      ...
      TableAction(
        null,
        PermissionHelper.checkPermission("edit_contact_types")
          ? this.editCrud
          : null
      ),
    ];
