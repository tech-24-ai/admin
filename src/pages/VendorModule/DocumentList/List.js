...
class DocumentList extends React.PureComponent {
    ...
    if (this.props.confirm.confirm) {
      if (this.props.confirm.data.length) {
        ...
        this.props.deleteAllCrud(
          "form",
          `documents-list/${this.props.match.params}/delete_all`,
          {
  ...
  editCrud(data) {
    this.props.history.push(
      `${this.getBasePath()}/document-list-form/${data.id}`
    );
  }
  ...
  addCrud() {
    this.props.history.push(`${this.getBasePath()}/document-list-form/new`);
  }
      ...
      <GridContainer>
        <GridItem xs={12}>
          <MaterialDataTable
            ...
            url={`documents-list/${this.props.match.params.id}`}
            selection={true}
            grouping={false}
