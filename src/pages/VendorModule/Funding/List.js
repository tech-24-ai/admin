...
const title = "Funding List";
class FundingList extends React.PureComponent {
  constructor(props) {
    super(props);
    ...
    if (this.props.confirm.confirm) {
      if (this.props.confirm.data.length) {
        ...
        this.props.deleteAllCrud(
          "form",
          `funding-list/${this.props.match.params}/delete_all`,
          {
  ...
  deleteData = (id) => {
    this.props.deleteCrud(
      "form",
      `funding-list/${this.props.match.params}`,
      id
    );
  };
  ...
  editCrud(data) {
    this.props.history.push(`${this.getBasePath()}/funding-form/${data.id}`);
  }
  ...
  addCrud() {
    this.props.history.push(`${this.getBasePath()}/funding-form/new`);
  }
      ...
      <GridContainer>
        <GridItem xs={12}>
          <MaterialDataTable
            ...
            url={`funding-list/${this.props.match.params.id}`}
            selection={true}
            grouping={false}
