...
class LocationsList extends React.PureComponent {
    ...
    if (this.props.confirm.confirm) {
      if (this.props.confirm.data.length) {
        ...
        this.props.deleteAllCrud(
          "form",
          `locations/${this.props.match.params}/delete_all`,
          {
  ...
  deleteData = (id) => {
    this.props.deleteCrud("form", `locations/${this.props.match.params}`, id);
  };
  ...
  editCrud(data) {
    this.props.history.push(`${this.getBasePath()}/locations-form/${data.id}`);
  }
  ...
  addCrud() {
    this.props.history.push(`${this.getBasePath()}/locations-form/new`);
  }
  ...
  render() {
    const columns = [
      ...
      TableAction(
        PermissionHelper.checkPermission("delete_vendor_locations")
          ? this.deleteCrud
          : null,
      ...
      <GridContainer>
        <GridItem xs={12}>
          <MaterialDataTable
            ...
            url={`locations/${this.props.match.params.id}`}
            selection={true}
            grouping={false}
