                        ...
                        <TableContainer component={Paper}>
                            <Table>
                                <TableBody>
                                    ...
                                    <TableRow>
                                        <TableCell component="th" scope="row">Payment Type</TableCell>
                                        {
                                            (state.payment_type == 1) ? <TableCell align="right">Subscription</TableCell> : 
                                            <TableCell align="right">Document Purchase</TableCell> 
                                        }
