...
class ConsultantReportsForm extends React.PureComponent {
    constructor(props) {
        super(props);
    ...
    handleSubmit(e) {
        ...
        if (this.validator.allValid()) {
            ...
            if (id && id === "new") {
                this.props.create("formData", "reports/consultantreport", data);
                this.goBack();
            } else {
                this.props.update("formData", "reports/consultantreport", id, response_data);
            }
        } else {
            this.handleError();
        }
    ...
    bindData = () => {
        const { id } = this.props.match.params;
        if (id && id !== "new") {
            crudService._get("reports/consultantreport", id).then((response) => {
    ...
    render() {
        ...
        const { id } = this.props.match.params;
        let title = "Add Consultant Reports";
        let btnText = "Create";
        if (id && id !== "new") {
            title = "Edit Consultant Reports Details";
            btnText = "Update";
        }
        // console.log("id", id);
        return (
...
ConsultantReportsForm.propTypes = {
