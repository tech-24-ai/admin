...
class TechnologyList extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  componentDidUpdate() {
    if (this.props.confirm.confirm) {
      if (this.props.confirm.data.length) {
        ...
        this.props.deleteAllCrud("form", "consultants/technology/delete_all", {
  ...
  deleteData = (id) => {
    this.props.deleteCrud("form", "consultants/technology", id);
  };
  ...
  editCrud(data) {
    this.props.history.push(`${this.getBasePath()}/technology-form/${data.id}`);
  }
  // changePassword = (data) => {
  ...
  // };
  addCrud() {
    this.props.history.push(`${this.getBasePath()}/technology-form/new`);
  }
  // export = () => {
  ...
  render() {
    const columns = [
      ...
      // ),
      TableAction(
        PermissionHelper.checkPermission("delete_technology")
          ? this.deleteCrud
          : null,
