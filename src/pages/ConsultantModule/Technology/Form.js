...
import { BLOG_STATUS, STATUS, YEAR } from "../../../_constants/form.constants";
...
class TechnologyForm extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  handleSubmit(e) {
    ...
    if (this.validator.allValid()) {
      ...
      if (childId && childId === "new") {
        this.props.create("formData", `consultants/technology`, data);
      } else {
        this.props.update("formData", `consultants/technology`, childId, data);
      }
      this.resetForm();
      this.goBack();
    } else {
  ...
  bindData = () => {
    ...
    if (childId && childId !== "new") {
      crudService._get(`consultants/technology`, childId).then((response) => {
