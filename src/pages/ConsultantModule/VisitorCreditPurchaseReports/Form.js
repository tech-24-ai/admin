...
class PaymentTransactionReportsForm extends React.PureComponent {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const { id } = this.props.match.params;
        let title = "Add Payment Transaction Reports";
        let btnText = "Create";
        if (id && id !== "new") {
            title = "Edit Payment Transaction Reports Details";
            btnText = "Update";
        }
        // console.log("id", id);
        return (
...
PaymentTransactionReportsForm.propTypes = {
