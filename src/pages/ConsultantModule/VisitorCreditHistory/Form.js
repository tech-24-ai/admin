...
class VisitorCreditHistoryForm extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    let title = "Add Visitor Credit History";
    let btnText = "Create";
    if (id && id !== "new") {
      title = "Edit Visitor Credit History Details";
      btnText = "Update";
    }
    // console.log("id", id);
    return (
...
VisitorCreditHistoryForm.propTypes = {
