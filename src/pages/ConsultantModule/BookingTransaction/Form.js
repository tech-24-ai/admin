...
class BookingTransactionForm extends React.PureComponent {
    constructor(props) {
        super(props);
    ...
    handleSubmit(e) {
        ...
        if (this.validator.allValid()) {
            ...
            if (childId && childId === "new") {
                this.props.create("formData", "booking-transaction", data);
                this.goBack();
            } else {
                this.props.update("formData", "booking-transaction", childId, data);
            }
        } else {
            this.handleError();
        }
    ...
    render() {
        ...
        let title = "Add Complains";
        let btnText = "Create";
        if (childId && childId !== "new") {
            title = "Edit Complains Details";
            btnText = "Update";
        }
        // console.log("id", id);
        return (
...
BookingTransactionForm.propTypes = {
