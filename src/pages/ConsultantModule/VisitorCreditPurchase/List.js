...
const title = "Visitor Credit Purchase";
class VisitorCreditPurchaseList extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    const columns = [
      ...
      // ),
      TableAction(
        PermissionHelper.checkPermission("delete_credit_purchase")
          ? this.deleteCrud
          : null,
