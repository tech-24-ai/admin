...
class VisitorCreditReportsForm extends React.PureComponent {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const { id } = this.props.match.params;
        let title = "Add VisitorCredit Reports Form";
        let btnText = "Create";
        if (id && id !== "new") {
            title = "Edit Visitor Credit Reports Details";
            btnText = "Update";
        }
        // console.log("id", id);
        return (
...
VisitorCreditReportsForm.propTypes = {
